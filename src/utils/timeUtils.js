export const isCurrentlyOpen = (hours) => {
  ...
  // Parse hours like "8am - 8pm" or "8:30am - 4:30pm (Closed 1-2pm)" -> didn't know how to parse it so this is part of the code is not mine :)
  // Currently we just skip the break hours. :)
