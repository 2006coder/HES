...
function ResultsList({ results }) {
  ...
  useEffect(() => {
    ...
    if (sortOption === "has-aetna") {
      resultsCopy = resultsCopy.filter(f => f["takeEarlhamAetnaInsurance"]);
    }
    ...
    switch(sortOption) {
      ...
      case "rating-desc":
        ...
        break;
      case "distance-asc":
        resultsCopy.sort((a, b) => (a.distance || 0) - (b.distance || 0));
        break;
      default:
  ...
  console.log("Print from ResultsList for sortedResults: ", sortedResults);
